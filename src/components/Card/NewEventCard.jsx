...
export default function NewEventCard({ event }) {
  ...
  const searchTerm = "BAGLI";

  // Check if the lowercase location contains the string 'BAGLI'
  if (!lowerCaseLocation.includes(searchTerm)) {
    // If location does not contain 'BAGLI', return null (render nothing)
    return null;
  }
  ...
  return (
    <div className="w-full rounded-xl p-3 bg-red-300 border-2 border-tred hover:scale-105 transition-transform hover:bg-red-500 hover:text-gray-200">
      ...
      <div className="w-full  flex flex-col justify-center p-2">
        ...
        <button
          className="w-1/3 rounded-md p-2 mt-3 bg-gray-200 text-sm outline-none text-black font-semibold duration-100 hover:text-white hover:bg-red-800"
          onClick={() => {
