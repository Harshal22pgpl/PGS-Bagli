...
const Header = ({ title }) => {
  return (
    <>
      ...
      <div className="relative bg-gradient-to-r from-red-700 to-pink-300 text-white overflow-hidden">

        {/* SVG Waves */}
        <svg
          className="waves absolute bottom-0 left-0 w-full h-32 md:h-48 lg:h-64"
          ...
          <div className="text-content md:order-1 px-6 py-8 md:py-0 flex flex-col justify-center">
            ...
            <div className="mt-4">
              <Link href='/admissions'>
                <button className='p-3 rounded-lg mr-2 bg-purple-900'>Admissions</button>
              </Link>
              <Link href='/studentLife'>
                <button className='p-3 rounded-lg bg-purple-900'>StudentLife</button>
              </Link>
            </div>
          </div>
