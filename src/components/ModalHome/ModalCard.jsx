  ...
  return (
    <>
      <div className="w-full h-full ">
        <h1 className="text-center p-3 text-tred text-5xl font-extrabold">
          Pratibha Global School, BAGLI
        </h1>
        <h2 className="text-center p-3 text-tred text-3xl font-extrabold">
        ...
        <div className="flex flex-col md:flex-row md:justify-around items-center bg-cover">
          ...
          <div className="hidden md:flex lg:flex flex-col justify-center items-center mt-5 md:mt-0 max-w-3xl">
            <Image
              alt="image"
              src="/homeGallary/HeroSectionImage (1).jpg"
              width={600}
              height={500}
