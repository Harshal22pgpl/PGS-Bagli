    ...
    <>
      ...
      <div className="flex flex-col gap-4 sm:flex-row w-full mt-10">
        <div className="w-full sm:w-1/2 p-1 h-[350px]">
          <h2 className="text-2xl bg-red-400 p-2 text-center">
        ...
        <div className="gap-4 p-1 h-[430px] w-full bg-bred">
          <div className="w-full h-full bg-bred">
            <h2 className="text-2xl bg-red-400 p-2 text-center">
            ...
            <div className="bg-bred  w-full mx-auto">
              <div className="flex mx-auto w-full h-full items-center justify-center">
                <ul
                  ref={listRef}
                  className="bg-bred w-full overflow-auto grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4 p-1 max-h-[376px]"
                >
    ...
    <li className="border-gray-400 flex flex-col">
      <Link href={`${route}`}>
        <div className="select-none cursor-pointer bg-gray-200 rounded-md flex flex-1 items-start p-3 ">
          ...
          {type === "event" && (
            <div className="bg-red-200 text-xs rounded-md p-1">Event</div>
          )}
          {type === "notice" && (
            <div className="bg-red-200 text-xs rounded-md p-1">Notice</div>
          )}
        </div>
      </Link>
    </li>
