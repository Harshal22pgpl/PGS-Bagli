                          ...
                          <ul className="">
                            ...
                            {values.map((value, index) => (
                              <li key={index} className="py-2">
                                ...
                                <div onClick={() => handleSidebarItemClick(value.path)} className='p-3 shadow-md rounded-lg bg-red-100 text-red-600'>
                                  {value.displayName}
                                </div>
                              </li>
                            ))}
...
function DropdownNavItem({ name, values }) {
  return (
    <div className="relative group">
      ...
      <div className="hidden text-start group-hover:block absolute z-10 bg-gradient-to-r from-red-400 to-red-100 p-5 rounded-lg w-64">
